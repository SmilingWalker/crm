...
<script type="text/javascript">
		...
		$("#saveRemark").click(function () {
			...
			$.ajax({
				...
				success:function (data) {
					//添加成功与否 返回添加成功的ActivityRemark对象
					if(data.success){
						let html = '';
						let n = data.activityRemark
						...
						html+= '&nbsp;&nbsp;&nbsp;&nbsp; '
						html+=
								'<a class="myHref" href="javascript:void(0);" onclick="removeRemark(\''+n.id+'\')"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #FF0000;"></span></a>'
						html+= '</div>'
						html+= '</div>'
						html+= '</div>'
	...
	function editRemark(id) {
		$("#remarkId").val(id);
		$("#noteContent").val($.trim($("#c"+id).html()))
...
<body>
	...
	<div style="position: relative; top: -70px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 30px;">
			...
			<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${a.createBy}&nbsp;
				&nbsp;</b><small
